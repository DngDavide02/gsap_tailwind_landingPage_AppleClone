  ...
  return (
    <section id="product-viewer">
      ...
      <div className="controls">
        <p className="info">MacBook Pro | Available in 14" & 16" in Space Gray or Dark colors</p>

        <div className="flex-center gap-5 mt-5">
          <div className="color-control">
            <div onClick={() => setColor("#abd5bd")} className={clsx("bg-neutral-300", color == "#adb5bd" && "active")} />
