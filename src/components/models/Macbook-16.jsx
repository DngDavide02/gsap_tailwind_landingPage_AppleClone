...
Files: macbook-16.glb [639.28KB] > C:\Users\dange\Desktop\coding\Projects\Landing page Tailwind\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
import { noChangeParts } from "../../costants";
...
export default function MacBookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        //Change color only if the part NOT noChangeParts
